...
#Ideally, we want the image duration to be 2.0 seconds, however, it can be seen that 
#the image duration is greater than 2.0 seconds which indicates that it is not very precise.
...
#This method used in Q2 is less precise than the method used in Q1 (core.wait). When this code is 
#executed, two of the values are below 1 second and one value is slightly above 1 second. While 
#the values are close to 1 second, I would say that the first method is more precise.
...
#I believe that this method is slightly less precise than the first method and slightly more precise than the second method.
#All of the values were around the same value, however, they all were slightly above one second. 
